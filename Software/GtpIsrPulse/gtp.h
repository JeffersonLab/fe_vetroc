...
/* 0x2400-0x24FF */	unsigned int			Reserved2[(0x2500-0x2400)/4];
/* 0x2500-0x25FF */	GtpTi_regs				TiGtp;
/* 0x2600-0x2FFF */	unsigned int			Reserved3[(0x3000-0x2600)/4];
...
/* 0x3700-0x3FFF */	unsigned int			Reserved4[(0x4000-0x3700)/4];
/* 0x4000-0x4FFF */	GtpTrigbit_regs		Trigbits[16];
/* 0x5000-0xFFFF */	unsigned int			Reserved5[(0x10000-0x6000)/4];
} Gtp_regs;
